    ...
    return(
        <form className="enrollForm">
            ...
            <label>Gender : 
                ...
                <input type="radio" name="gender" onChange={handleChange} value="Female"/><label>Others</label>
            </label><br/>
            <label>Skills : 
                ...
                <input type="checkbox" name="skills" onChange={handleSkills} value="Java" className="skills"/><label>JS</label>
                <input type="checkbox" name="skills" onChange={handleSkills} value="AWS" className="skills"/><label>AWS</label>
                <input type="checkbox" name="skills" onChange={handleSkills} value="Android" className="skills"/><label>Android</label>
            </label><br/>
